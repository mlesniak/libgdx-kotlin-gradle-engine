...
class Engine(private val canvas: Canvas) {
    ...
    fun triangle(p0_: Vector, p1_: Vector, p2_: Vector, rgb: Int = 0x555555) {
        ...
        // We don't know which side is the lower one.
        // Since the list is sorted by the interpolation,
        // we can simply check the middle element to
        // figure out the smaller list.
        val m = x012.size / 2
